...
These are the slides for presentations I did at the LSU Discover Day Undergraduate Research Symposium during my bachelor's degree. 
...
BibTeX:
```
@misc{MettigDiscoverDay2020,
  author = {Raphaela Mettig},
  title = {LSU Discover Day - Malware DB: Pre-processing Malicious Samples for Preliminary Analysis},
  year = {2020},
  howpublished = {GitHub Repository},
  url = {https://github.com/rmettig/LSU-Discover-Day},
...
BibTeX:
```
@misc{MettigDiscoverDay2019,
  author = {Raphaela Mettig},
  title = {LSU Discover Day - Automated Unpacking of Malware with Memory Forensics},
  year = {2019},
  howpublished = {GitHub Repository},
  url = {https://github.com/rmettig/LSU-Discover-Day},
  note = {Accessed: YYYY-MM-DD}
